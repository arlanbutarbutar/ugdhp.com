                                ...
                                <div class="col-md-12">
                                    <div class="row flex-row-reverse">
                                        <?php if($_SESSION['id-role']<=3){?>
                                            <div class="col-lg-4">
                                                <?php if($_SESSION['id-role']==3){?>
                                                <div class="card card-body shadow border-light text-center mt-3 bg-<?= $bgMode?> <?= $colorMode?>">
                                                ...
                                                <div class="card card-body shadow border-light text-center mt-3 bg-<?= $bgMode?> <?= $colorMode?>">
                                                    ...
                                                    <form action="" method="POST">
                                                        <div class="form-group">
                                                            <textarea name="problem-message" cols="30" rows="5" placeholder="Masukan masalah system" class="form-control bg-<?= $bgMode?> <?= $colorMode?>" required></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <button type="submit" name="submit-report-problem" class="btn btn-<?= $btnMode?> mt-3 btn-sm">Apply</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-8 mb-5">
                                            ...
                                            <?php }if(mysqli_num_rows($report_problem)>0){while($row=mysqli_fetch_assoc($report_problem)){?>
                                                <div class="card card-body shadow border-light mt-3 bg-<?= $bgMode?> <?= $colorMode?>">
