...
$_SESSION['page-name']="Laporan DP";$_SESSION['page-to']="report-dp";
?>
<!DOCTYPE html>
<html lang="id">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form action="" method="POST">
                                                                    <div class="input-group mb-3">
                                                                        <input type="number" name="note" class="form-control bg-<?= $bgMode?> <?= $colorMode?>" placeholder="Cari Nota DP">
                                                                        <div class="input-group-append">
                                                                            <button class="btn btn-outline-info border-top-left-radius-0 border-bottom-left-radius-0" type="submit" name="search-nota-dp"><i class="fas fa-search"></i></button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                                ...
                                                                <form action="" method="POST">
                                                                    <div class="input-group mb-3">
                                                                        ...
                                                                        <div class="input-group-append">
                                                                            <button class="btn btn-outline-info border-top-left-radius-0 border-bottom-left-radius-0" type="submit" name="search-date-dp"><i class="fas fa-search"></i></button>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            </div>
                                            ...
                                            <nav class="small mt-3" aria-label="Page navigation example">
                                                <ul class="pagination justify-content-center">
                                                    ...
                                                    <li class="page-item shadow">
                                                        <a class="page-link border-0" href="report-dp?page=<?= $page10-1;?>" tabindex="-1" aria-disabled="true">Previous</a>
                                                    </li>
                                                    <?php endif;?>
                                                    <?php for($i=1; $i<=$total_page10; $i++):?>
                                                        <?php if($i<=5):?>
                                                            <?php if($i==$page10):?>
                                                                <li class="page-item shadow"><a class="page-link font-weight-bold border-0" href="report-dp?page=<?= $i;?>"><?= $i;?></a></li>
                                                            <?php else :?>
                                                    ...
                                                    <li class="page-item shadow">
                                                        <a class="page-link border-0" href="report-dp?page=<?= $page10+1;?>">Next</a>
                                                    </li>
                                                    <?php endif;}}?>
                                                </ul>
                                            </nav>
