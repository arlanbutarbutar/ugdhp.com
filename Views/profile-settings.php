...
$_SESSION['page-name']="Settings";$_SESSION['page-to']="profile-settings";
?>
<!DOCTYPE html>
<html lang="id">
                                        ...
                                        <div class="card-body">
                                            <form action="" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" name="password1" placeholder="Sandi baru" class="form-control bg-<?= $bgMode?> <?= $colorMode?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Ulangi Kata sandi baru</label>
                                                    <input type="password" name="password2" placeholder="Ulangi sandi" class="form-control bg-<?= $bgMode?> <?= $colorMode?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <button type="submit" name="ubah-sandi-user" class="btn btn-<?= $btnMode?> btn-sm mt-3">Ubah</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
