                                        ...
                                        <div class="col-lg-4">
                                            <div class="card card-body shadow mt-3 text-center">
                                                ...
                                                <form action="" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        <button type="submit" name="submit-help" class="btn btn-dark mt-3 btn-sm">Apply</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card card-body shadow mt-3">
                                                        <blockquote class="blockquote mb-0">
                                                            ...
                                                            <form action="" method="POST">
                                                                ...
                                                                <div class="form-group">
                                                                    <button type="submit" name="help-admin" class="btn btn-dark mt-3 btn-sm">Apply</button>
                                                                </div>
                                                            </form>
