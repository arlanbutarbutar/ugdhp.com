                                                    ...
                                                    <form action="" method="POST">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <textarea name="privacy-policy" cols="30" rows="5" placeholder="Masukan Kebijakan" class="form-control bg-<?= $bgMode?> <?= $colorMode?>" required></textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <tbody>
                                                    <tr style="border:hidden">
                                                        <td><form action="" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                <textarea name="privacy-policy" cols="30" rows="10" class="form-control bg-<?= $bgMode?> <?= $colorMode?>"><?= $row['privacy_policy']?></textarea>
                                                            </div>
