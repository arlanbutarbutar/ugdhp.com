                                            ...
                                            <div class="card-body text-center">
                                                <form action="" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <button type="submit" name="edit-profile-employee" class="btn btn-dark btn-sm shadow mt-5">Edit</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-8 mt-3">
                                        <div class="card shadow border-0" style="overflow-x: auto">
                                            <div class="card-body">
                                                <table class="table table-borderless table-sm">
                                                    ...
                                                    <tbody class="text-dark">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>: <?= $row['email']?> <a class="btn btn-outline-dark btn-sm" data-toggle="collapse" href="#edit-email-user" role="button" aria-expanded="false" aria-controls="edit-email-user">Edit</a>
                                                        </td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <p class="text-center">
                                                    <button class="btn btn-dark btn-sm shadow" type="button" data-toggle="collapse" data-target="#edit-biodata-user" aria-expanded="false" aria-controls="edit-biodata-user">
                                                        Edit
                                                    </button>
                                                </p>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="collapse" id="edit-email-user">
                                        <div class="card card-body shadow mt-3 text-center">
                                            <div class="row">
                                                <div class="col-lg-6 m-auto">
                                                    <form action="" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" name="edit-email-user" class="btn btn-dark btn-sm shadow mt-3">Apply</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card card-body shadow mt-3 text-center">
                                            <div class="col-lg-6 m-auto">
                                                ...
                                                <form action="" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        <button type="submit" name="edit-biodata-user" class="btn btn-dark btn-sm mt-3">Apply</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
